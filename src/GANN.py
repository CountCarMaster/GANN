...
class GANN(nn.Module):
    def __init__(self, num_points, k, output_channel):
        ...
        self.knn1 = new_knn(in_channel=10, num_points=self.num_points)
        self.knn2 = new_knn(in_channel=64, num_points=self.num_points)
        self.knn3 = new_knn(in_channel=64, num_points=self.num_points)
        self.knn4 = new_knn(in_channel=128, num_points=self.num_points)
